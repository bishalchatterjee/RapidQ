...
public class QuestionsList implements Serializable {
    ...
    private final String question,option1,option2,option3,option4,url;
    private final int answer;
    private int userSelectedAnswer;

    public QuestionsList(String question, String option1, String option2, String option3, String option4,String url, int answer) {
